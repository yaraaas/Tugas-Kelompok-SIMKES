...
<header class="about-header"><div class="container"><h2>Poli Umum</h2><p class="text-muted">Pintu pertama untuk kesehatan Anda dan keluarga.</p></div></header>
<div class="container mb-5"><div class="row justify-content-center"><div class="col-lg-8"><div class="card card-about">
<p>Layanan kesehatan primer yang tulus untuk seluruh warga Krapyak, mulai dari pemeriksaan fisik hingga konsultasi keluhan harian.</p>
<h5 class="mt-4 mb-3" style="font-weight: 700;">Layanan Unggulan:</h5>
<ul class="feature-list">
    <li><b>Pemeriksaan Fisik:</b> Tensi, suhu tubuh, dan konsultasi kesehatan harian.</li>
    <li><b>Pengobatan Umum:</b> Penanganan flu, batuk, demam, dan infeksi ringan.</li>
    <li><b>Surat Keterangan:</b> Layanan pembuatan surat keterangan sehat untuk berbagai keperluan.</li>
</ul>
<div class="text-center"><a href="booking.php" class="btn-booking-now">Daftar Antrean Poli Umum</a><br><a href="index.php" class="btn mt-3" style="background-color: var(--midnight-blue); color: white; border-radius: 12px; padding: 8px 20px; font-size: 0.85rem; font-weight: 600; text-decoration: none; transition: 0.3s;">← Kembali ke Beranda</a></div>
</div></div></div></div>
