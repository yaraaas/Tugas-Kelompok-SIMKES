...
<header class="about-header"><div class="container"><h2>Poli Gigi</h2><p class="text-muted">Senyum sehat warga, kebanggaan Desa Krapyak.</p></div></header>
<div class="container mb-5"><div class="row justify-content-center"><div class="col-lg-8"><div class="card card-about">
<p>Wujudkan senyum cerah bersama Poli Gigi SIMKES. Kami hadir dengan peralatan steril dan penanganan lembut untuk meminimalisir rasa takut.</p>
<h5 class="mt-4 mb-3" style="font-weight: 700;">Layanan Unggulan:</h5>
<ul class="feature-list">
    <li><b>Pembersihan Karang:</b> Scaling rutin untuk menjaga kesegaran mulut dan gusi.</li>
    <li><b>Penambalan Gigi:</b> Solusi estetis dan fungsional untuk gigi berlubang.</li>
    <li><b>Edukasi Gigi Anak:</b> Membiasakan sikat gigi dengan cara yang seru dan menyenangkan.</li>
</ul>
<div class="text-center"><a href="booking.php" class="btn-booking-now">Daftar Antrean Poli Gigi</a><br><a href="index.php" class="btn mt-3" style="background-color: var(--midnight-blue); color: white; border-radius: 12px; padding: 8px 20px; font-size: 0.85rem; font-weight: 600; text-decoration: none; transition: 0.3s;">← Kembali ke Beranda</a></div>
</div></div></div></div>
